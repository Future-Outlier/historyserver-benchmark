...
- Date: 2026-08-06T16:44:53-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-5f6b4cf7df-7r7nd/historyserver | historyserver | 37 | 1190.1 | 1193.6 | 1.111 | 2.284 |  |
| historyserver-demo-5f6b4cf7df-7r7nd/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1195.1 |
...
| /enter_cluster cold load | 34.285s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 420ms | 421ms | 421ms | 408 B | 0 |
| /api/jobs/ | 14ms | 118ms | 118ms | 1.31 KiB | 0 |
| /nodes?view=summary | 10ms | 14ms | 14ms | 2.77 KiB | 0 |
| /events | 16ms | 117ms | 117ms | 2.48 KiB | 0 |
