...
- Date: 2026-08-06T17:00:33-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-65887b79cf-4mxnw/historyserver | historyserver | 36 | 1191.5 | 1194.5 | 1.088 | 1.969 |  |
| historyserver-demo-65887b79cf-4mxnw/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1194.8 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 8ms / 85ms / 85ms (errors: 0) |
| /enter_cluster cold load | 32.585s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 511ms | 636ms | 636ms | 408 B | 0 |
| /api/jobs/ | 11ms | 14ms | 14ms | 1.31 KiB | 0 |
| /nodes?view=summary | 12ms | 112ms | 112ms | 2.77 KiB | 0 |
