...
- Date: 2026-08-06T16:38:01-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6fddb7cf6c-4cpb5/historyserver | historyserver | 41 | 1123.8 | 1126.6 | 0.951 | 1.027 |  |
| historyserver-demo-6fddb7cf6c-4cpb5/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1127.8 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 5ms / 83ms / 83ms (errors: 0) |
| /enter_cluster cold load | 37.803s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 908ms | 1.108s | 1.108s | 408 B | 0 |
| /api/jobs/ | 212ms | 260ms | 260ms | 1.31 KiB | 0 |
| /nodes?view=summary | 14ms | 17ms | 17ms | 2.77 KiB | 0 |
| /events | 35ms | 314ms | 314ms | 2.48 KiB | 0 |
