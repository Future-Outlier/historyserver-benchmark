...
- Date: 2026-08-06T16:47:07-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6fddb7cf6c-j9mkh/historyserver | historyserver | 41 | 1120.8 | 1123.6 | 0.948 | 1.030 |  |
| historyserver-demo-6fddb7cf6c-j9mkh/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1125.0 |
...
| /enter_cluster cold load | 37.904s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 882ms | 902ms | 902ms | 408 B | 0 |
| /api/jobs/ | 13ms | 14ms | 14ms | 1.31 KiB | 0 |
| /nodes?view=summary | 10ms | 11ms | 11ms | 2.77 KiB | 0 |
| /events | 171ms | 212ms | 212ms | 2.48 KiB | 0 |
