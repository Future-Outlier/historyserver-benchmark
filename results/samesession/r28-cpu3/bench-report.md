...
- Date: 2026-08-06T17:01:14-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-65887b79cf-9tkjr/historyserver | historyserver | 36 | 913.3 | 999.9 | 1.132 | 1.770 |  |
| historyserver-demo-65887b79cf-9tkjr/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1031.8 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 6ms / 88ms / 88ms (errors: 0) |
| /enter_cluster cold load | 34.448s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 457ms | 500ms | 500ms | 408 B | 0 |
| /api/jobs/ | 11ms | 16ms | 16ms | 1.31 KiB | 0 |
| /nodes?view=summary | 19ms | 93ms | 93ms | 2.77 KiB | 0 |
| /events | 11ms | 18ms | 18ms | 2.48 KiB | 0 |
