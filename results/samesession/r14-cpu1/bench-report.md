...
- Date: 2026-08-06T16:49:21-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6fddb7cf6c-tbmxf/historyserver | historyserver | 44 | 909.6 | 1138.8 | 0.953 | 1.038 |  |
| historyserver-demo-6fddb7cf6c-tbmxf/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1159.5 |
...
| /enter_cluster cold load | 40.256s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 925ms | 926ms | 926ms | 408 B | 0 |
| /api/jobs/ | 14ms | 25ms | 25ms | 1.31 KiB | 0 |
| /nodes?view=summary | 11ms | 17ms | 17ms | 2.77 KiB | 0 |
| /events | 161ms | 250ms | 250ms | 2.48 KiB | 0 |
