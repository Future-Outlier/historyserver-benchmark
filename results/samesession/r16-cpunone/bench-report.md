...
- Date: 2026-08-06T16:51:39-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-5f6b4cf7df-cvpkb/historyserver | historyserver | 38 | 834.3 | 1018.0 | 1.096 | 2.006 |  |
| historyserver-demo-5f6b4cf7df-cvpkb/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1042.8 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 6ms / 85ms / 85ms (errors: 0) |
| /enter_cluster cold load | 36.078s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 410ms | 434ms | 434ms | 408 B | 0 |
| /api/jobs/ | 15ms | 111ms | 111ms | 1.31 KiB | 0 |
| /nodes?view=summary | 12ms | 15ms | 15ms | 2.77 KiB | 0 |
| /events | 15ms | 104ms | 104ms | 2.48 KiB | 0 |
