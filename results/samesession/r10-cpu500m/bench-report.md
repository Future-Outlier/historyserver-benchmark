...
- Date: 2026-08-06T16:45:35-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6785ff6464-j67sp/historyserver | historyserver | 86 | 968.7 | 1208.8 | 0.486 | 0.531 |  |
| historyserver-demo-6785ff6464-j67sp/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1209.5 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 7ms / 137ms / 137ms (errors: 0) |
| /enter_cluster cold load | 1m19.323s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 2.076s | 2.129s | 2.129s | 408 B | 0 |
| /api/jobs/ | 11ms | 13ms | 13ms | 1.31 KiB | 0 |
| /nodes?view=summary | 56ms | 404ms | 404ms | 2.77 KiB | 0 |
| /events | 86ms | 491ms | 491ms | 2.48 KiB | 0 |
