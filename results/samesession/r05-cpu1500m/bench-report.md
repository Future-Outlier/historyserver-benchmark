...
- Date: 2026-08-06T16:42:00-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-7d676b97c8-gthj4/historyserver | historyserver | 42 | 1121.4 | 1124.3 | 1.051 | 1.484 |  |
| historyserver-demo-7d676b97c8-gthj4/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1125.6 |
...
| /enter_cluster cold load | 39.211s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 637ms | 676ms | 676ms | 408 B | 0 |
| /api/jobs/ | 133ms | 157ms | 157ms | 1.31 KiB | 0 |
| /nodes?view=summary | 15ms | 16ms | 16ms | 2.77 KiB | 0 |
| /events | 12ms | 204ms | 204ms | 2.48 KiB | 0 |
