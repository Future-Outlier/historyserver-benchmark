...
- Date: 2026-08-06T16:59:55-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-5f6b4cf7df-l6hzl/historyserver | historyserver | 34 | 1189.8 | 1194.4 | 1.155 | 2.400 |  |
| historyserver-demo-5f6b4cf7df-l6hzl/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1197.2 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 6ms / 91ms / 91ms (errors: 0) |
| /enter_cluster cold load | 32.152s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 426ms | 443ms | 443ms | 408 B | 0 |
| /api/jobs/ | 9ms | 10ms | 10ms | 1.31 KiB | 0 |
| /nodes?view=summary | 10ms | 12ms | 12ms | 2.77 KiB | 0 |
| /events | 24ms | 129ms | 129ms | 2.48 KiB | 0 |
