...
- Date: 2026-08-06T16:56:48-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-65887b79cf-fk5t6/historyserver | historyserver | 40 | 1237.7 | 1241.2 | 1.056 | 1.856 |  |
| historyserver-demo-65887b79cf-fk5t6/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1241.8 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 5ms / 84ms / 84ms (errors: 0) |
| /enter_cluster cold load | 37.231s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 406ms | 445ms | 445ms | 408 B | 0 |
| /api/jobs/ | 13ms | 102ms | 102ms | 1.31 KiB | 0 |
| /nodes?view=summary | 10ms | 12ms | 12ms | 2.77 KiB | 0 |
| /events | 13ms | 100ms | 100ms | 2.48 KiB | 0 |
