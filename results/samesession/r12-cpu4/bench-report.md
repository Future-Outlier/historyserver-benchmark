...
- Date: 2026-08-06T16:47:53-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-7fb85b6799-7kstd/historyserver | historyserver | 38 | 1186.0 | 1190.1 | 1.073 | 2.065 |  |
| historyserver-demo-7fb85b6799-7kstd/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1192.4 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 16ms / 84ms / 84ms (errors: 0) |
| /enter_cluster cold load | 36.367s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 405ms | 510ms | 510ms | 408 B | 0 |
| /api/jobs/ | 11ms | 12ms | 12ms | 1.31 KiB | 0 |
| /nodes?view=summary | 116ms | 136ms | 136ms | 2.77 KiB | 0 |
| /events | 10ms | 14ms | 14ms | 2.48 KiB | 0 |
