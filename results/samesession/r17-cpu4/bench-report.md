...
- Date: 2026-08-06T16:52:21-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-7fb85b6799-t92kg/historyserver | historyserver | 34 | 1186.3 | 1190.1 | 1.078 | 1.954 |  |
| historyserver-demo-7fb85b6799-t92kg/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1191.0 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 8ms / 90ms / 90ms (errors: 0) |
| /enter_cluster cold load | 31.486s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 435ms | 491ms | 491ms | 408 B | 0 |
| /api/jobs/ | 8ms | 14ms | 14ms | 1.31 KiB | 0 |
| /nodes?view=summary | 14ms | 15ms | 15ms | 2.77 KiB | 0 |
| /events | 43ms | 130ms | 130ms | 2.48 KiB | 0 |
