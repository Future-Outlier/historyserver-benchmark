...
- Date: 2026-08-06T17:03:12-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6785ff6464-f5tzc/historyserver | historyserver | 92 | 1111.8 | 1114.5 | 0.487 | 0.523 |  |
| historyserver-demo-6785ff6464-f5tzc/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1115.7 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 7ms / 135ms / 135ms (errors: 0) |
| /enter_cluster cold load | 1m25.811s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 1.902s | 2.102s | 2.102s | 408 B | 0 |
| /api/jobs/ | 413ms | 427ms | 427ms | 1.31 KiB | 0 |
| /nodes?view=summary | 16ms | 82ms | 82ms | 2.77 KiB | 0 |
| /events | 69ms | 408ms | 408ms | 2.48 KiB | 0 |
