...
- Date: 2026-08-06T16:53:01-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6f87d5d7c9-5bwbd/historyserver | historyserver | 40 | 1121.2 | 1125.4 | 1.061 | 1.982 |  |
| historyserver-demo-6f87d5d7c9-5bwbd/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1126.9 |
...
| /enter_cluster cold load | 36.827s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 610ms | 694ms | 694ms | 408 B | 0 |
| /api/jobs/ | 126ms | 136ms | 136ms | 1.31 KiB | 0 |
| /nodes?view=summary | 15ms | 16ms | 16ms | 2.77 KiB | 0 |
| /events | 12ms | 142ms | 142ms | 2.48 KiB | 0 |
