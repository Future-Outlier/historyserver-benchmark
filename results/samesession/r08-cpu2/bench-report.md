...
- Date: 2026-08-06T16:44:14-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6f87d5d7c9-ph8j2/historyserver | historyserver | 34 | 1116.4 | 1120.7 | 1.102 | 1.740 |  |
| historyserver-demo-6f87d5d7c9-ph8j2/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1122.3 |
...
| /enter_cluster cold load | 31.902s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 539ms | 582ms | 582ms | 408 B | 0 |
| /api/jobs/ | 11ms | 13ms | 13ms | 1.31 KiB | 0 |
| /nodes?view=summary | 112ms | 118ms | 118ms | 2.77 KiB | 0 |
