...
- Date: 2026-08-06T16:50:09-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6785ff6464-lmqx5/historyserver | historyserver | 83 | 1102.8 | 1105.9 | 0.486 | 0.525 |  |
| historyserver-demo-6785ff6464-lmqx5/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1107.0 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 6ms / 133ms / 133ms (errors: 0) |
| /enter_cluster cold load | 1m15.295s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 2.104s | 3.315s | 3.315s | 408 B | 0 |
| /api/jobs/ | 17ms | 58ms | 58ms | 1.31 KiB | 0 |
| /nodes?view=summary | 15ms | 477ms | 477ms | 2.77 KiB | 0 |
| /events | 88ms | 597ms | 597ms | 2.48 KiB | 0 |
