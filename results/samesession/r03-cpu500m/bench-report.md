...
- Date: 2026-08-06T16:39:38-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-6785ff6464-nvkfx/historyserver | historyserver | 91 | 1071.4 | 1189.3 | 0.487 | 0.544 |  |
| historyserver-demo-6785ff6464-nvkfx/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1191.5 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 15ms / 137ms / 137ms (errors: 0) |
| /enter_cluster cold load | 1m25.681s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 2.223s | 2.272s | 2.272s | 408 B | 0 |
| /api/jobs/ | 15ms | 64ms | 64ms | 1.31 KiB | 0 |
| /nodes?view=summary | 10ms | 13ms | 13ms | 2.77 KiB | 0 |
| /events | 400ms | 571ms | 571ms | 2.48 KiB | 0 |
