...
- Date: 2026-08-06T16:48:36-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-7d676b97c8-xf9r4/historyserver | historyserver | 40 | 1117.6 | 1121.6 | 1.048 | 1.488 |  |
| historyserver-demo-7d676b97c8-xf9r4/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1122.9 |
...
| /enter_cluster cold load | 36.672s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 661ms | 953ms | 953ms | 408 B | 0 |
| /api/jobs/ | 14ms | 15ms | 15ms | 1.31 KiB | 0 |
| /nodes?view=summary | 13ms | 171ms | 171ms | 2.77 KiB | 0 |
| /events | 17ms | 186ms | 186ms | 2.48 KiB | 0 |
