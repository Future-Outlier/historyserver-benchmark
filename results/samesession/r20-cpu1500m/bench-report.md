...
- Date: 2026-08-06T16:54:25-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-7d676b97c8-rl862/historyserver | historyserver | 42 | 1131.0 | 1134.1 | 1.041 | 1.514 |  |
| historyserver-demo-7d676b97c8-rl862/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1135.2 |
...
| /enter_cluster cold load | 39.579s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 675ms | 724ms | 724ms | 408 B | 0 |
| /api/jobs/ | 13ms | 15ms | 15ms | 1.31 KiB | 0 |
| /nodes?view=summary | 148ms | 153ms | 153ms | 2.77 KiB | 0 |
| /events | 12ms | 158ms | 158ms | 2.48 KiB | 0 |
