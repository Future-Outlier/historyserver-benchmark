...
- Date: 2026-08-06T16:43:30-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-5f6b4cf7df-n8h62/historyserver | historyserver | 39 | 1187.5 | 1191.5 | 1.079 | 2.069 |  |
| historyserver-demo-5f6b4cf7df-n8h62/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1193.6 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 6ms / 90ms / 90ms (errors: 0) |
| /enter_cluster cold load | 36.355s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 423ms | 429ms | 429ms | 408 B | 0 |
| /api/jobs/ | 11ms | 123ms | 123ms | 1.31 KiB | 0 |
| /nodes?view=summary | 9ms | 12ms | 12ms | 2.77 KiB | 0 |
| /events | 12ms | 113ms | 113ms | 2.48 KiB | 0 |
