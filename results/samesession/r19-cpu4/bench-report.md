...
- Date: 2026-08-06T16:53:46-05:00
...
|---|---|---|---|---|---|---|---|
| historyserver-demo-7fb85b6799-wm7f5/historyserver | historyserver | 35 | 1108.2 | 1112.2 | 1.157 | 2.089 |  |
| historyserver-demo-7fb85b6799-wm7f5/historyserver | lifetime | 0 | 0.0 | 0.0 | 0.000 | 0.000 | 1113.7 |
...
| metric | value |
|---|---|
| GET /clusters p50 / p95 / max | 7ms / 99ms / 99ms (errors: 0) |
| /enter_cluster cold load | 32.684s (HTTP 200) |

| warm endpoint | p50 | p95 | max | resp bytes | errors |
|---|---|---|---|---|---|
| /api/v0/tasks?limit=50000 | 0s | 0s | 0s | 0 B | 3 |
| /api/v0/tasks/summarize | 399ms | 433ms | 433ms | 408 B | 0 |
| /api/jobs/ | 11ms | 14ms | 14ms | 1.31 KiB | 0 |
| /nodes?view=summary | 46ms | 132ms | 132ms | 2.77 KiB | 0 |
| /events | 15ms | 17ms | 17ms | 2.48 KiB | 0 |
